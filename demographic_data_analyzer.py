...
def calculate_demographic_data(print_data=True):
    # Read data from file
    df = pd.read_csv('123_FCC\\ProyCert\\Demographic Data Analyzer\\adult.data.csv')
    ...
    highest_earning_country = (rich_by_country / country_count *100).idxmax()
    highest_earning_country_percentage = round((rich_by_country / country_count * 100).max(),1)
